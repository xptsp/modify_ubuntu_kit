...
apt remove -y --purge --autoremove cups-daemon 
apt remove -y --purge --autoremove thunar-dropbox-plugin
apt remove -y --purge --autoremove remarkable 
apt remove -y --purge --autoremove github-desktop
